                        ...
                        <div class="information">
                            ...
                            <div class="description">
                                <p>저희 쇼핑몰을 이용해 주셔서 감사합니다. <strong class="txtEm"><span><span
                                    ...
                                    <strong>[<span class="xans-member-var-group_name">member[멤버]</span><span
                ...
                <form id="editForm" name="editForm" action="/exec/front/Member/edit/" method="post" target="_self"
                    ...
                    <div class="xans-element- xans-member xans-member-edit">
                                ...
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td>
                                            <input id="member_id" name="member_id"
                                                ...
                                                readonly="readonly" value="아이디표시되는곳" type="text"> (영문소문자/숫자, 4~16자)
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="">
                                        ...
                                        <td><input id="name" name="name" fw-filter="isFill&amp;isMax[30]" fw-label="이름"
                                                ...
                                                readonly="readonly" value="이름이표시되는곳" type="text"></td>
                                    </tr>
                                    <tr class="">
                                            ...
                                            <ul class="ec-address">
                                                <li id="fmodify_zipcode_wrap" class="ec-address-zipcode">
                                                    <input id="postcode1" name="postcode1" placeholder="우편번호"
                                                        ...
                                                        readonly="" fw-label="우편번호"> <button id="postBtn"
                                    ...
                                    <tr class="">
                                        ...
                                        <td><select id="phone1" name="phone[]" fw-filter="isNumber&amp;isNumber"
                                                ...
                                                value="" type="text">-<input id="phone3" name="phone[]" maxlength="4"
                                                fw-filter="isNumber&amp;isNumber" fw-label="일반전화" fw-alone="N" fw-msg=""
                                                value="" type="text"></td>
                                    </tr>
                                    <tr class="">
                                        ...
                                        <td>
                                            ...
                                            <input id="mobile2" name="mobile[]" maxlength="4"
                                                ...
                                                placeholder="" value="" type="text">-<input id="mobile3" name="mobile[]"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="email1" name="email1" fw-filter="isFill&amp;isEmail"
                                                fw-label="이메일" fw-alone="N" fw-msg="" placeholder="" value=""
                                                type="text">
                                    </tr>
                                    <tr class="">
                                ...
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td><input id="birth_year" name="birth_year" fw-filter="" fw-label="생년월일"
                                                ...
                                                value="1694" type="text"> 년 <input id="birth_month" name="birth_month"
                                                fw-filter="" fw-label="생년월일" fw-msg="" class="inputTypeText"
                                                placeholder="" maxlength="2" value="7" type="text"> 월 <input
                                                id="birth_day" name="birth_day" fw-filter="" fw-label="생년월일" fw-msg=""
                                                class="inputTypeText" placeholder="" maxlength="2" value="4"
                                                type="text">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <span id="id_bank_info">[산적은행] 123-4567-890 / 예금주: 해적왕</span> <a
                                                href="#none" class="btnNormal gIndent10"
                                                onclick="window.open('http://localhost:9090/slimbear/views/refund.jsp','bank_account','width=700,height=500');return false;"><span
                        ...
                        <div class="ec-base-button justify">
                            <a href="http://localhost:9090/slimbear/views/modify.jsp" class="btnSubmitFix sizeM" onclick="memberEditAction()">회원정보수정</a>
                            <a href="http://localhost:9090/slimbear/views/index.jsp" class="btnEmFix sizeM">취소</a>
                            <span class="gRight">
                            <!-- 아직 어찌할지 고민중 -->
                                <a href="#none" class="btnNormal sizeS" onclick="window.open('http://localhost:9090/slimbear/views/quit.jsp','quit','width=900,height=500');return false;">회원탈퇴</a>
                            </span>
                        </div>
