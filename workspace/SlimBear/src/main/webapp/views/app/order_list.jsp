			...
			<div id="contents">
				<div id="myMenu" class="xans-element- xans-myshop xans-myshop-main ">
					<ul>
						...
						<li class="board"><a href="/app/member/myPage/boardList"><span>게시글관리</span></a></li>
						<li class="board"><a href="/app/member/myPage/addr"><span>배송지관리</span></a></li>
					</ul>
				</div>
				...
				<div class="gKYVxm">
					<div class="kcHmyx">
						...
						<div class="kThsCL">
							<a href="/app/member/myPage/orderList/detail" class="gSIruC">주문 상세보기</a>
																	...
																	<div class="sc-8q24ha-3 gFbjJh">
																		<div class="jxRaeI">
																			<span font-weight="normal" color="#555555"
																				class="eDgzyT">${item2.orderAmount} 원</span> <span class="kYtEGM">
																				<span class="joIhoV"></span>
																			</span> <span class="jtWNEg">${item2.orderCount} 개 </span>
																		</div>
																	</div>
																</a>
