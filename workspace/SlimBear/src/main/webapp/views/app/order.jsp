...
<%
    request.setAttribute("name", "이상혁");
    request.setAttribute("email", "lumin4546@naver.com");
    request.setAttribute("phoneOne", "010");
    request.setAttribute("phoneTwo", "3534");
    request.setAttribute("phoneThree", "9767");
	...
	<form onsubmit="return validateForm();" method="post" action="">
		...
		<div class="member">
			...
			<div id="hiddenContent03" class="delivery" style="display: none;">
				<!-- 2. 필드 -->
				<div class="field">
					<b>주문자*</b> <span class="placehold-text"><input class="iddd" type="text" value="${name}"></span>
				</div>
				<div class="field">
					<b>이메일*</b> <input class="email" type="text" value="${email}">
					<!-- type이 password로 되어있어서 text로 바꿈 -->
				</div>
				<div class="field birth">
					<b>휴대전화</b>
					<div>
						<input type="number" placeholder="010" value="${phoneOne}"> <input type="number" placeholder="1234" value="${phoneTwo}"> <input type="number" placeholder="5678" value="${phoneThree}">
					</div>
				</div>

				<!-- 5. 이메일_전화번호 -->
				<div class="field">
					<b>비상 연락망<small>(선택)</small></b> <input type="number" placeholder="선택입력" value="${choicephone}">
				</div>
                ...
                <option value="">대한민국 +82</option>
					...
					<div>
						<input type="tel" placeholder="" value="${postNum}"> <input type="button" value="주소 찾기">
					</div>
					<input type="text" placeholder="기본 주소" value="${addressOne}"> <input type="text" placeholder="상세 주소" value="${addressTwo}">
				</div>
			</div>
			...
			<div class="radioo">
				<p>
					...
					</label> <label> <input type="radio" name="payment1" value="type5">새로운 배송지
			...
			<div class="field">
				<b>받는사람*</b> <span class="placehold-textt"><input type="text" value="${name}"></span>
			</div>
			<div class="field tel-number">
				<b>주소</b>
				<div>
			...
			<div class="field birth">
				<b>휴대전화</b>
				<div>
					<input type="text" placeholder="010" value="${phoneOne}"> <input type="text" placeholder="1234" value="${phoneTwo}"> <input type="text" placeholder="5678" value="${phoneThree}">
				</div>
			</div>
			...
			<article class="discount">
				...
				<div>
					...
					<label> <input class="pointt" type="text" name="point" placeholder="00,000점" value="${usepoint}"> <input type="button" value="적용">
			...
			<article class="payment">
				...
				<div>
					<span>신용카드</span>
					<p>
						<label> <input type="radio" name="payment" value="type1">신용카드 결제
						</label> <label> <input type="radio" name="payment" value="type2">체크카드 결제
						</label>
					</p>
				</div>
				<div>
					<span>계좌이체</span>
					<p>
						<label> <input type="radio" name="payment" value="type3" checked>실시간 계좌이체
						</label> <label> <input type="radio" name="payment" value="type4">무통장 입금
						</label>
					</p>
				</div>
