    ...
    <div id="wrap">
        <div id="container">
            <div id="contents">
                ...
                <form id="editForm" name="editForm" action="/app/member/myPage/modify/update" method="post" target="_self"
                            ...
                            <table border="1" summary="">
                                ...
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td>
                                            <input id="member_id" name="userID"
                                        ...
                                        <td>
                                            <ul class="ec-address">
                                                ...
                                                <li id="fmodify_baseAddr_wrap" class="">
                                                    <input id="addr1" name="defaultAddr" placeholder="기본주소" fw-filter=""
                                                ...
                                                <li id="fmodify_detailAddr_wrap" class="">
                                                    <input id="addr2" name="remainAddr" placeholder="나머지 주소(선택 입력 가능)"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="email1" name="email" fw-filter="isFill&amp;isEmail"
