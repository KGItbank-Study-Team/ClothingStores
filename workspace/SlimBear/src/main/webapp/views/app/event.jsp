		...
		<main>
			<div class="xans-element- xans-product xans-product-menupackage ">
				...
				<div
					...
					<p class="banner">
						<img
							src="https://cafe24img.poxo.com/anne2173/web/upload/category/shop1_297_top_663957.jpg"
					...
					-->
							<div class="function" id="Product_ListMenu">
								...
								<span class="compare displaynone"> <a href="#none"
									class="btnCompare" onclick="EC_ListAction.setProductCompare();">상품비교</a>
								</span>
							</div>
						...
						<li id="anchorBoxId_7902" class="xans-record-">
							...
							<div class="description">
								...
								<ul
									...
									<li class=" xans-record-"><strong
										...
										<div class="color">
											<span class="chips" title="#CFBCAE"
												...
												displayGroup="1"></span> <span class="chips" title="#845E22"
												style="background-color: #845E22" color_no=""
												displayGroup="1"></span>
										</div></li>
									<li class=" xans-record-"><strong
										class="title displaynone"> <span
									...
									</strong> <span style="font-size: 12px; color: #555555;"> 최종할인판매가
											<span
											style="font-size: 11px; color: #fa6767; font-weight: bold;"><%=discountPercentage%>
												%</span>
									</span></li>
									<li class=" xans-record-"><strong
										class="title displaynone"> <span
