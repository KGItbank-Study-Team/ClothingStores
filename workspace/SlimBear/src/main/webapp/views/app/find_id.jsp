						...
						<div class="findId">
							<div class="titleArea">
								...
								<ul>
									...
									<li>이메일, 전화번호 또는 주민등록번호 중 찾을 방법을 선택한 후,<br />이름과 정보를
										입력해 주세요.
									</li>
								</ul>
							</div>
							<fieldset>
								...
								<p class="check">
									<input id="check_method1" name="check_method" value="1"
										...
										onclick="toggleFields('2')"  checked="checked"/> <label for="check_method2">휴대폰
										번호</label> <input id="check_method3" name="check_method" value="3"
										type="radio" onclick="toggleFields('3')" /> <label
										for="check_method3">주민등록번호</label>
								...
								<p id="ssn_view" class="ssn_no" style="display: none;">
									<strong>주민등록번호로 찾기</strong> <input id="ssn1" name="ssn1"
										...
										fw-msg="" class="lostInput" placeholder="0000000" maxlength="7" value=""
										type="password" />
								</p>
